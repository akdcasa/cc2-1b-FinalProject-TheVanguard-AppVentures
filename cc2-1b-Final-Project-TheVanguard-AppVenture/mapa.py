...
def game_loop():
    ...
    enemies = [Enemy(random.randint(0, MAP_WIDTH - 1), random.randint(0, MAP_HEIGHT - 1)) for _ in range(5)]
    ...
    while True:
        ...
        for enemy in enemies:
            if player.x == enemy.x and player.y == enemy.y:
                ...
                # Add your combat logic or any other action for encountering an enemy here
